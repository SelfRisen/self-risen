...
export class ReflectionController extends BaseController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new reflection session. If categoryId is provided, the session is tied to that Wheel of Life category and a prompt is generated. If omitted, a global session (no category) is created.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a reflection session by ID. User must own the session.',
  })
  @ApiParam({
    name: 'sessionId',
  ...
  async getSessionById(
    ...
    const result = await this.reflectionService.getSessionById(
      user.uid,
      sessionId,
    );
    if (result.isError) throw result.error;
  ...
  @ApiOperation({
    ...
    description:
      'Submits a belief (text or audio) for a reflection session. If audio is provided, it will be transcribed automatically.',
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
    ...
    schema: {
      ...
      properties: {
        text: {
          type: 'string',
          description:
            "Text input of the user's belief. Optional if audio file is provided.",
        ...
        file: {
          ...
          format: 'binary',
          description:
            "Audio file containing the user's belief. Optional if text is provided.",
        },
      },
    },
  })
  ...
  @ApiOperation({
    ...
    description:
      "Transforms the user's limiting belief into an empowering affirmation using AI. Session must be in BELIEF_CAPTURED status. Optional voice is stored on the affirmation and does not change the user's default.",
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
  ...
  async generateAffirmation(
    ...
    const result = await this.reflectionService.generateAffirmation(
      user.uid,
      sessionId,
      dto,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Allows the user to edit the AI-generated affirmation text after it has been generated. Session must be in AFFIRMATION_GENERATED status. AI-generated audio is cleared so the user can regenerate voice for the new text.',
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
  ...
  @ApiOperation({
    summary: 'Edit belief',
    description:
      'Allows the user to edit the belief text after the AI has generated the affirmation. Session must be in AFFIRMATION_GENERATED status. Affirmation and audio are unchanged.',
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
  ...
  @ApiOperation({
    ...
    description:
      'Selects a sound from the stater-videos music list by name and sets it as the reflection session background sound (1:1). Replaces existing sound if present.',
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
  ...
  @ApiResponse({
    status: 404,
    description: 'Reflection session not found or sound name not found',
  })
  async createReflectionSound(
    ...
    const result = await this.reflectionService.createReflectionSound(
      user.uid,
      sessionId,
      dto.name,
    );
  ...
  @ApiOperation({
    ...
    description:
      "Returns the reflection session's sound (1:1), or null if none set.",
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
  ...
  async getSoundForReflection(
    ...
    const result = await this.reflectionService.getSoundForReflection(
      user.uid,
      sessionId,
    );
    if (result.isError) throw result.error;
  ...
  @ApiOperation({
    ...
    description:
      'Allows user to re-record their belief. If session has affirmation generated, it will be reset to BELIEF_CAPTURED status.',
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
  ...
  @ApiOperation({
    ...
    description:
      "Uploads user's voice recording of the affirmation. This will be used for playback instead of AI-generated audio.",
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
    ...
    schema: {
      ...
      properties: {
        file: {
          ...
          format: 'binary',
          description:
            "Audio file containing the user's voice recording of the affirmation.",
        },
      },
    },
  })
  ...
  @ApiOperation({
    ...
    description:
      'Tracks when user listens to the affirmation. Increments playback count and updates last played timestamp.',
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
  ...
  async trackPlayback(
    ...
    const result = await this.reflectionService.trackPlayback(
      user.uid,
      sessionId,
    );
    if (result.isError) throw result.error;
  ...
  @ApiOperation({
    ...
    description:
      "Regenerates the AI-generated affirmation audio. Optionally accepts a voice persona (Sage, Phoenix, River, Quinn, Alex, Robin). If not provided, uses the affirmation's or user's saved preference. Session must have a selected affirmation and be in AFFIRMATION_GENERATED status.",
  })
  @ApiParam({
    name: 'sessionId',
    description: 'The unique identifier of the reflection session',
  ...
  @ApiBody({
    ...
    required: false,
    description:
      'Optional voice persona for regeneration. Valid values: Sage, Phoenix, River, Quinn, Alex, Robin.',
    examples: {
      withPreference: {
  ...
  async regenerateAffirmationVoice(
    ...
    const result = await this.reflectionService.regenerateAffirmationVoice(
      user.uid,
      sessionId,
      dto,
    );
  ...
  @ApiOperation({
    summary: 'List waves',
    description:
      "Returns all waves for the current user across sessions, newest first, with each session's selected affirmation for display.",
  })
  ...
  async getAllWaves(
    ...
    const pageNumber = page ? parseInt(page, 10) : 1;
    const limitNumber = limit ? parseInt(limit, 10) : 10;
    const result = await this.reflectionService.getAllWaves(
      user.uid,
      pageNumber,
      limitNumber,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new wave (listening period) for an existing reflection session. Blocks creation if session already has an active wave. Session must have a selected affirmation.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Updates an existing wave. Can modify duration or active status. When duration is updated, the end date is automatically recalculated from the start date. If activating a wave, ensures no other active wave exists for the session.',
  })
  @ApiParam({
    name: 'waveId',
  ...
  @ApiResponse({
    status: 400,
    description:
      'Cannot activate wave - session already has another active wave',
  })
  @ApiResponse({
    status: 404,
  ...
  async updateWave(
    ...
    const result = await this.reflectionService.updateWave(
      user.uid,
      waveId,
      dto,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Deletes a wave from a reflection session. Returns the updated session.',
  })
  @ApiParam({
    name: 'waveId',
    description: 'The unique identifier of the wave',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves affirmations for the current user with pagination. If sessionId is provided, returns only affirmations for that reflection session; otherwise returns all affirmations across sessions, ordered by creation.',
  })
  @ApiQuery({
    name: 'sessionId',
    required: false,
    type: String,
    description:
      'Optional reflection session ID to filter affirmations by session',
    example: 'session-id-123',
  })
  @ApiQuery({
    name: 'page',
  ...
  async selectAffirmation(
    ...
    const result = await this.reflectionService.selectAffirmation(
      user.uid,
      sessionId,
      affirmationId,
    );
  ...
  @ApiOperation({
    ...
    description:
      "Removes an affirmation from the session. Cannot delete if it's the only affirmation or if it's currently selected.",
  })
  @ApiParam({
    name: 'affirmationId',
  ...
  @ApiResponse({
    status: 400,
    description:
      'Cannot delete the only affirmation or the selected affirmation',
  })
  @ApiResponse({
    status: 404,
    description: 'Reflection session or affirmation not found',
  ...
  async deleteAffirmation(
    ...
    const result = await this.reflectionService.deleteAffirmation(
      user.uid,
      affirmationId,
    );
    if (result.isError) throw result.error;
