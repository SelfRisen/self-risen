...
export class AffirmationResponseDto {
  ...
  @ApiProperty({
    description:
      'Whether this affirmation is selected as the active one for this session',
    example: true,
  })
  isSelected: boolean;
  ...
  @ApiProperty({
    description:
      'Voice persona used for this affirmation (persisted per affirmation; does not change if user changes default)',
    enum: PERSONA_NAMES,
    required: false,
    nullable: true,
    example: 'Sage',
